...
const Competitions = () => {
  return (
    <>
      ...
      <section className="bg-black w-full overflow-auto min-h-[92vh] pt-5">
              ...
              <tbody className="border text-white">
                ...
                <tr className="border border-[#D891EF] text-white">
                  ...
                  <td className="border border-[#D891EF] text-white text-left py-2 px-3">
                    This was the level 3 contest in the Speech Evaluation
                    Contest. I belonged to the District-98 where I had
                    represented my Division that is Division-N.
                  </td>
                ...
                <tr className="border border-[#D891EF] text-white">
                  ...
                  <td className="border border-[#D891EF] text-white text-left py-2 px-3">
                    This was the level 2 contest in the Speech Evaluation
                    Contest. I belonged to the Division-N where I had
                    represented my College Club that is SSIPMT Spellbinders
                    Club.
                  </td>
                  <td className="border border-[#D891EF] text-white text-xl text-center py-2 px-3">
                    Winner
                ...
                <tr className="border border-[#D891EF] text-white">
                  ...
                  <td className="border border-[#D891EF] text-white text-left py-2 px-3">
                    This was the level 1 contest in the Speech Evaluation
                    Contest. I belonged to the SSIPMT Spellbinders Club where I
                    had represented myself as a competitor to other participants
                    from the same club.
                  </td>
                  <td className="border border-[#D891EF] text-white text-xl text-center py-2 px-3">
                    Winner
                ...
                <tr className="border border-[#D891EF] text-white">
                  ...
                  <td className="border border-[#D891EF] text-white text-left py-2 px-3">
                    This was the level 1 contest in the Humourous Speech
                    Contest. I belonged to the SSIPMT Spellbinders Club where I
                    had represented myself as a competitor to other participants
                    from the same club.
                  </td>
